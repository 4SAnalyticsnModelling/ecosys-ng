...
pub const RootParameters = struct {
    ...
    radial_resistivity_m2_per_megapascal_per_h: f64,
    axial_resistivity_m2_per_megapascal_per_h: f64,
};
...
/// Translates `startq.f` lines 390--403 for one plant species.
pub fn initialize(
    root: RootParameters,
    ...
    return .{
        ...
        .radial_resistivity_m2_per_megapascal_per_h = root.radial_resistivity_m2_per_megapascal_per_h,
        .axial_resistivity_m2_per_megapascal_per_h = root.axial_resistivity_m2_per_megapascal_per_h,
    };
}
...
fn validateRoot(root: RootParameters) InitializationError!void {
    ...
    inline for (.{
        root.radial_resistivity_m2_per_megapascal_per_h,
        root.axial_resistivity_m2_per_megapascal_per_h,
    }) |resistivity| {
...
test "mycorrhiza copies root uptake and resistance parameters in STARTQ order" {
    const root = RootParameters{
        ...
        .radial_resistivity_m2_per_megapascal_per_h = 10.0,
        .axial_resistivity_m2_per_megapascal_per_h = 11.0,
    };
    ...
    try std.testing.expectEqual(
        root.axial_resistivity_m2_per_megapascal_per_h,
        mycorrhiza.axial_resistivity_m2_per_megapascal_per_h,
    );
}
