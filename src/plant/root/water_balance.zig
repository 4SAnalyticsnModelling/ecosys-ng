...
fn layerUptake(context: ResidualContext, root: usize, canopy_water_potential_megapascal: f64) f64 {
    ...
    const unconstrained = context.root_conductance_m_per_h_megapascal[root] * (context.soil_water_potential_megapascal[soil_layer] - canopy_water_potential_megapascal);
...
pub fn commitRootHydraulics(
    ...
    for (0..plant_count) |plant| {
        ...
        for (0..biological_domain_count_for_plant) |domain| for (0..result.soil_layer_count) |layer| {
            ...
            const canopy_potential = plants.canopy_water_potential_megapascal[plant];
