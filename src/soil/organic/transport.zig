...
fn solveDomain(allocator: std.mem.Allocator, amounts_g: []f64, water_m3: []const f64, faces: []const @import("../solute/transport.zig").Face, conductance: []const f64, options: Options) !SolverResult {
...
fn residualAt(base: []const f64, trial: []const f64, water: []const f64, faces: []const @import("../solute/transport.zig").Face, conductance: []const f64, maximum_fraction: f64, fixed_point: []f64, residual: []f64) !void {
