...
/// Source-ordered micropore species from `hour1.f` lines 2795--2844.
...
/// Source-ordered macropore species from `hour1.f` lines 2845--2893.
...
/// Translates `hour1.f` lines 2795--2893. Static-equilibrium mode is a no-op.
