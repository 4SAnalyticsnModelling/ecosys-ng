...
pub fn applyTile(context: *ApplyContext, range: compute.CellRange) !void {
    ...
    for (range.first..range.end) |layer| for (0..substrates) |substrate| {
        ...
        for (0..populations) |population| {
            ...
            const water = @exp(context.parameters.heterotrophic_respiration.water_potential_sensitivity_per_megapascal * context.matric_plus_osmotic_potential_megapascal[layer]);
