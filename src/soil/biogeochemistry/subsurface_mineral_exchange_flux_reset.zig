...
/// Source-ordered band and mineral transformations, `hour1.f` lines 3431--3486.
...
/// Source-ordered micropore/macropore exchange fluxes, `hour1.f` lines 3487--3553.
...
/// Source-ordered water, heat, gas, and root diagnostics, `hour1.f` lines 3560--3573.
...
/// Translates `hour1.f` lines 3431--3573. Fluxes retain their legacy
