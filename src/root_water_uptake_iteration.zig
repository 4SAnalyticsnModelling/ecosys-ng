...
pub const Inputs = struct {
    ...
    canopy_gravitational_water_potential_mpa: f64,
...
pub const Result = struct {
    ...
    height_adjusted_canopy_water_potential_mpa: f64,
...
pub fn calculate(
    ...
    if (@abs(inputs.current_canopy_temperature_k -
        ...
        return .{
            ...
            .height_adjusted_canopy_water_potential_mpa = inputs.canopy_total_water_potential_mpa -
                inputs.canopy_gravitational_water_potential_mpa,
    ...
    return .{
        ...
        .height_adjusted_canopy_water_potential_mpa = canopy_potential,
...
fn sourceInputs() Inputs {
    return .{
        ...
        .canopy_gravitational_water_potential_mpa = -0.02,
