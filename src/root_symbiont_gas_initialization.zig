...
pub const Parameters = struct {
    ...
    carbon_dioxide_solubility_temperature_c_inv: f64,
    oxygen_solubility_multiplier: f64,
    oxygen_solubility_intercept: f64,
    oxygen_solubility_temperature_c_inv: f64,
};
...
/// Translates STARTQ lines 791-811 for runtime population-layer compartments.
pub fn initialize(
    ...
    const aqueous_co2_concentration_g_c_m3 =
        ...
        @exp(parameters.carbon_dioxide_solubility_intercept +
            parameters.carbon_dioxide_solubility_temperature_c_inv *
    ...
    const aqueous_oxygen_concentration_g_o_m3 =
        ...
        @exp(parameters.oxygen_solubility_intercept +
            parameters.oxygen_solubility_temperature_c_inv *
                forcing.air_temperature_c) *
...
fn legacyParameters() Parameters {
    return .{
        ...
        .carbon_dioxide_solubility_temperature_c_inv = -0.0317,
        .oxygen_solubility_multiplier = 0.032,
        .oxygen_solubility_intercept = -6.175,
        .oxygen_solubility_temperature_c_inv = -0.0211,
    };
}
