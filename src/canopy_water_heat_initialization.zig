...
pub const Result = struct {
    ...
    absolute_canopy_water_potential_mpa: f64,
...
pub fn calculate(inputs: Inputs) !Result {
    ...
    const result = Result{
        ...
        .absolute_canopy_water_potential_mpa = absolute_potential,
...
test "UPTAKE canopy water and heat initialization preserves source equations" {
    ...
    try std.testing.expectEqual(@as(f64, 2), result.absolute_canopy_water_potential_mpa);
