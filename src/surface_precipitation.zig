...
pub fn prepareFromModel(state: *RuntimeState, atmosphere: *const @import("atmospheric_forcing.zig").State, grid: *const @import("grid.zig").GridState, canopy: ?*const @import("canopy_precipitation_retention.zig").State, cell_area_m2: []const f64, snow_depth_m: []const f64, full_snow_cover_depth_m: f64, maximum_iterations: u16) !void {
...
pub fn commitSoilIngress(state: *const RuntimeState, grid: *@import("grid.zig").GridState, hydrology: *@import("transport_hydrology.zig").State, timestep_h: f64) !void {
...
test "litter-soil flux uses litter donor temperature when flow is into soil" {
    const result = try surface_water_flow.litterSoilFlux(.{
        ...
        .litter_water_fraction = 0.4,
        .soil_water_fraction = 0.2,
        .litter_air_entry_water_fraction = 0.1,
        .soil_air_entry_water_fraction = 0.1,
        .litter_total_water_potential_mpa = -0.05,
        .soil_total_water_potential_mpa = -0.1,
        .litter_hydraulic_conductivity_m2_per_h_mpa = 1,
        .soil_hydraulic_conductivity_m2_per_h_mpa = 1,
    ...
    const expected_flux = try water_flux.calculateMatrixFaceFlux(.{
        .direction = .vertical,
        .source_water_m3 = 1,
        .destination_water_m3 = 0.2,
        .source_air_m3 = 0.5,
        .destination_air_m3 = 0.5,
        .source_micropore_volume_m3 = 1,
        .destination_micropore_volume_m3 = 1,
        .source_water_fraction = 0.4,
        .destination_water_fraction = 0.2,
        .source_air_entry_water_fraction = 0.1,
        .destination_air_entry_water_fraction = 0.1,
        .source_total_water_potential_mpa = -0.05,
        .destination_total_water_potential_mpa = -0.1,
        .source_hydraulic_conductivity_m2_per_h_mpa = 1,
        .destination_hydraulic_conductivity_m2_per_h_mpa = 1,
        .source_path_length_m = 0.05,
        .destination_path_length_m = 0.05,
        .face_area_m2 = 1,
        .wetting_depth_factor = 1,
        .time_fraction = 1,
    });
    try std.testing.expectApproxEqAbs(
        expected_flux.limited_water_m3,
        result.water_m3,
        1e-15,
    );
    try std.testing.expectApproxEqAbs(
...
test "litter-soil flux uses soil donor temperature when flow is upward" {
    const inputs = surface_water_flow.LitterSoilInputs{
        ...
        .litter_air_entry_water_fraction = 0.1,
        .soil_air_entry_water_fraction = 0.1,
        .litter_total_water_potential_mpa = -0.1,
        .soil_total_water_potential_mpa = -0.05,
        .litter_hydraulic_conductivity_m2_per_h_mpa = 1,
        .soil_hydraulic_conductivity_m2_per_h_mpa = 1,
        .litter_thickness_m = 0.05,
        .soil_thickness_m = 0.05,
