...
pub const GridState = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, cfg: SimulationConfig) !GridState {
        ...
        const matric_potential_mpa = try allocator.alloc(f64, layer_count);
        errdefer allocator.free(matric_potential_mpa);
        ...
        @memset(matric_potential_mpa, 0.0);
    ...
    pub fn deinit(self: *GridState) void {
        ...
        self.allocator.free(self.matric_potential_mpa);
    ...
    pub fn validateFinite(self: GridState) !void {
        ...
        try validateField("matric_potential_mpa", self.matric_potential_mpa);
...
pub const PlantState = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, cfg: SimulationConfig) !PlantState {
        ...
        const canopy_water_potential_mpa = try allocator.alloc(f64, cell_species_count);
        errdefer allocator.free(canopy_water_potential_mpa);
        ...
        @memset(canopy_water_potential_mpa, -0.1);
        ...
        return .{
            ...
            .canopy_water_potential_mpa = canopy_water_potential_mpa,
    ...
    pub fn deinit(self: *PlantState) void {
        ...
        self.allocator.free(self.canopy_water_potential_mpa);
    ...
    pub fn validateFinite(self: PlantState) !void {
        ...
        try validateField("canopy_water_potential_mpa", self.canopy_water_potential_mpa);
