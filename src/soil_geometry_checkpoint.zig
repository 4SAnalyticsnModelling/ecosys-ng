...
const Geometry = @import("soil_layer_geometry.zig").State;
const Hydrology = @import("transport_hydrology.zig").State;
const Surface = @import("surface_precipitation.zig").RuntimeState;
const Erosion = @import("soil_erosion.zig").RuntimeState;
const Climate = @import("climate_change.zig").State;
const ErodedMinerals = @import("soil_erosion_mineral_bridge.zig").State;
const Runtime = @import("soil_runtime_checkpoint.zig");
const SurfaceBoundary = @import("surface_boundary_checkpoint.zig");
const SurfaceLitterGeometry = @import("surface_litter_geometry_step.zig").State;
...
const TestRuntime = struct {
    allocator: std.mem.Allocator,
    properties: @import("soil_solver_properties.zig").State,
    thermal: @import("soil_thermal.zig").State,
...
const TestSurfaceBoundary = struct {
    allocator: std.mem.Allocator,
    ground_air: @import("ground_air_exchange.zig").State,
    aerodynamics: @import("surface_aerodynamics.zig").State,
