...
pub const State = struct {
    ...
    row_count: usize,
    column_count: usize,
    directional_longwave_radiation_mj_per_step: []f64,
    directional_sensible_heat_mj_per_step: []f64,
    ...
    total_longwave_radiation_mj_per_step: []f64,
    total_sensible_heat_mj_per_step: []f64,
