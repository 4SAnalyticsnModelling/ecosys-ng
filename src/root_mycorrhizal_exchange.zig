...
fn validateInputs(inputs: Inputs) !void {
    ...
    const scalars = [_]f64{ inputs.minimum_mycorrhiza_to_root_volume_ratio, inputs.exchange_rate_h_inv, inputs.biological_timestep_h };
...
fn exchangeSalt(workspace: State, inputs: Inputs, species: usize, layer: usize, root_volume_m3: f64, mycorrhizal_volume_m3: f64, combined_volume_m3: f64) void {
    ...
    const transfer_mol = inputs.exchange_rate_h_inv * concentration_difference_mol * inputs.biological_timestep_h;
