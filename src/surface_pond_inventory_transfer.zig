...
fn validateNitrogenFertilizer(source: surface_fertilizer_module.Inventory, destination: @import("soil_fertilizer_dissolution.zig").FertilizerState, fraction: f64) !void {
    inline for (.{
