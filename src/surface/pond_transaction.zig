...
const geometry_module = @import("../soil/profile/layer_geometry.zig");
...
test "late surface chemistry failure leaves organic gas and fertilizer inventories unchanged" {
    ...
    defer grid.deinit();
    var surface_geometry = try @import("litter_geometry_step.zig").State.init(std.testing.allocator, 1);
    ...
    var thermal: @import("../soil/heat/thermal.zig").State = undefined;
