...
/// `hour1.f` lines 1927--1959. Runtime material classes replace source indices
...
fn validate(inputs: Inputs) !void {
    ...
    if (inputs.dissolved_organic_carbon_g_c < 0 or
        ...
        !std.math.isFinite(inputs.hygroscopic_potential_megapascal) or
        !std.math.isFinite(inputs.minimum_potential_megapascal) or
        inputs.hygroscopic_potential_megapascal >= 0 or
        inputs.minimum_potential_megapascal >= 0)
        return error.InvalidDisturbedLitterHydraulicInput;
}
