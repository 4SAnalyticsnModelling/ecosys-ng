...
pub fn parse(source: []const u8) !Parameters {
    ...
    try expectRecord(&tokens, "litter_water_potential_megapascal");
...
fn expectedRecordValueCount(label: []const u8) ?usize {
    ...
    const entries = [_]Entry{
        ...
        .{ .name = "litter_water_potential_megapascal", .count = scalarCount(litter_water_environment.Parameters) },
...
const source_parameter_text =
    ...
    "litter_water_potential_megapascal -0.0005 -1.5e12 -1.5e4 0.5 0.5\n" ++
