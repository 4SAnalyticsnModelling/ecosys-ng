...
const mineral = @import("erosion_mineral_fertilizer_flux.zig");
const exchange = @import("erosion_exchange_surface_flux.zig");
const precipitate = @import("erosion_precipitate_silicate_flux.zig");
const organic = @import("erosion_organic_matter_flux.zig");
const directional_reset = @import("erosion_directional_flux_reset.zig");
