...
const soil_thermal = @import("../soil/heat/thermal.zig");
...
pub fn fields(
    ...
    const base = [_]tile_state_store.Field{
        ...
        field("matric_potential_megapascal", grid.matric_potential_megapascal, soil_layers),
        field("surface_temperature_k", grid.surface_temperature_k, 1),
        field("canopy_temperature_k", plants.canopy_temperature_k, species),
        field("canopy_water_potential_megapascal", plants.canopy_water_potential_megapascal, species),
...
pub fn mutableFields(
    ...
    const base = [_]tile_state_store.MutableField{
        ...
        mutableField("matric_potential_megapascal", grid.matric_potential_megapascal, soil_layers),
        ...
        mutableField("canopy_water_potential_megapascal", plants.canopy_water_potential_megapascal, species),
