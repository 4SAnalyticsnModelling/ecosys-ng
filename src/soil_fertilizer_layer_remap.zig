...
const nitrogen_module = @import("fertilizer_nitrogen_inventory.zig");
const nitrogen_pools = @import("soil_fertilizer_dissolution.zig");
const mineral_module = @import("mineral_fertilizer_inventory.zig");
