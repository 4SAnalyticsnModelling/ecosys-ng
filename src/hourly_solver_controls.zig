...
pub const Inputs = struct {
    ...
    fire_active: bool,
    top_layer_heat_capacity_megajoules_per_k_by_cell: []const f64,
...
pub fn derive(inputs: Inputs) !Controls {
    ...
    if (inputs.top_layer_heat_capacity_megajoules_per_k_by_cell.len == 0 or
        inputs.top_layer_heat_capacity_megajoules_per_k_by_cell.len !=
    ...
    for (
        inputs.top_layer_heat_capacity_megajoules_per_k_by_cell,
        inputs.top_layer_horizontal_area_m2_by_cell,
    ) |heat_capacity_megajoules_per_k, area_m2| {
        ...
        low_heat_capacity = low_heat_capacity or
            heat_capacity_megajoules_per_k < 4.19e-3 * area_m2;
    }
...
fn baseInputs() Inputs {
    return .{
        ...
        .fire_active = false,
        .top_layer_heat_capacity_megajoules_per_k_by_cell = &.{ 1, 2 },
