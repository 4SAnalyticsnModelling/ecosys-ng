...
const GrowthState = @import("plant_growth_stages.zig").State;
const PlantPhenologyState = @import("plant_phenology.zig").State;
const BranchDevelopmentState = @import("plant_phenology.zig").BranchDevelopmentState;
const RootState = @import("plant_root_system.zig").State;
const RetentionState = @import("canopy_precipitation_retention.zig").State;
const PlantState = @import("grid.zig").PlantState;
const execution_calendar_date = @import("execution_calendar_date.zig");

/// GROSUB lines 7535--7538 DEATHR predicate with the runtime per-plant
