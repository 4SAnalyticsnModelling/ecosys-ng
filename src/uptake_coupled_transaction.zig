...
const canopy_energy = @import("canopy_water_energy_publication.zig");
const minimum_stomatal = @import("canopy_minimum_stomatal_resistance.zig");
const root_water = @import("root_water_uptake_publication.zig");
const root_gas_content = @import("root_gas_content_publication.zig");
const root_gas_withdrawal = @import("root_gas_withdrawal_publication.zig");
const root_nutrient = @import("root_nutrient_uptake_publication.zig");
