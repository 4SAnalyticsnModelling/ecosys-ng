...
const snow_salt = @import("../surface/snow_redistribution_salt_update.zig");
...
/// redist.f lines 5485--5500, retaining the original charge-class grouping.
...
/// Exact standalone translation of redist.f lines 5470--5518.
