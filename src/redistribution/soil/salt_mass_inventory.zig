...
const micro = @import("salt_micropore_update.zig");
const macro = @import("salt_macropore_update.zig");
const exchange_update = @import("exchange_site_update.zig");
const phosphate_update = @import("phosphate_precipitate_update.zig");
const mineral_update = @import("precipitate_silicate_update.zig");
