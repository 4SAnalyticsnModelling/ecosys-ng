...
/// STARTS 754--766 and 1023--1028: midpoint cumulative humus and its
...
/// STARTS 1290--1356 derives OSCM and the FOSCI/FOSNI/FOSPI limitation
...
pub const State = struct {
    ...
    /// Translates STARTS 1293--1467 for one mineral-soil layer. Results are
...
test "mapped STARTS organic initialization uses runtime profile selection and geometry" {
    ...
    var properties = try SoilProperties.initMapped(allocator, &grid, catalog.entries.items, &.{0}, &.{1}, &.{1}, @import("soil_solver_properties.zig").compatibilityParameters());
