...
const reaction = @import("soil_denitrification.zig");
...
pub fn applyTile(context: *ApplyContext, range: compute.CellRange) !void {
    ...
    for (range.first..range.end) |layer| {
        ...
        const inactive_water_fraction = try context.retention_curve[layer].waterFractionAtPotentialMpa(context.parameters.oxygen_uptake.hygroscopic_water_potential_mpa);
